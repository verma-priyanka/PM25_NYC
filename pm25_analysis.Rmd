...
# write to geotiffs
writeRaster(kendall_output$tau, filename = "tau.tif", format="GTiff", overwrite=TRUE)
writeRaster(kendall_output$sl, filename ="p-value.tif", format="GTiff", overwrite=TRUE)
```
